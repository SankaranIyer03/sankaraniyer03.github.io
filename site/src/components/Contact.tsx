    ...
    <>
      <section id="contact" className="relative overflow-hidden border-b border-line">
        ...
        >
          ...
          <motion.h2
            variants={riseIn}
            className="mt-7 max-w-4xl text-[clamp(2rem,5.4vw,4.2rem)] leading-[1.02] font-medium tracking-[-0.035em]"
          >
          ...
          >
            ...
            industrialization, and automation roles where the job is the whole loop rather than one
            stage of it. Happy to talk through any of the work above in detail.
          </motion.p>
